...
geo147 = [['Ni', np.array([ 0.,  0.,  0.])],
 ['Ni', np.array([ 0.        ,  1.52416694,  2.46615392])],
 ['Ni', np.array([ 1.52416694,  2.46615392,  0.        ])],
 ['Ni', np.array([ 2.46615392,  0.        ,  1.52416694])],
 ['Ni', np.array([-1.52416694,  2.46615392,  0.        ])],
 ['Ni', np.array([-2.46615392,  0.        ,  1.52416694])],
 ['Ni', np.array([ 0.        , -1.52416694,  2.46615392])],
 ['Ni', np.array([-1.52416694, -2.46615392,  0.        ])],
 ...
 ['Ni', np.array([-2.46615392,  0.        , -1.52416694])],
 ['Ni', np.array([ 0.        , -1.52416694, -2.46615392])],
 ['Au', np.array([ 0.        ,  3.04833388,  4.93230783])],
 ['Au', np.array([ 1.52416694,  3.99032086,  2.46615392])],
 ['Au', np.array([ 2.46615392,  1.52416694,  3.99032086])],
 ['Au', np.array([ 3.04833388,  4.93230783,  0.        ])],
 ['Au', np.array([ 3.99032086,  2.46615392,  1.52416694])],
 ['Au', np.array([ 4.93230783,  0.        ,  3.04833388])],
 ['Au', np.array([-1.52416694,  3.99032086,  2.46615392])],
 ['Au', np.array([ 0.        ,  4.93230783,  0.        ])],
 ['Au', np.array([-3.04833388,  4.93230783,  0.        ])],
 ['Au', np.array([-2.46615392,  1.52416694,  3.99032086])],
 ['Au', np.array([-3.99032086,  2.46615392,  1.52416694])],
 ['Au', np.array([-4.93230783,  0.        ,  3.04833388])],
 ['Au', np.array([ 0.        ,  0.        ,  4.93230783])],
 ['Au', np.array([-2.46615392, -1.52416694,  3.99032086])],
 ['Au', np.array([ 0.        , -3.04833388,  4.93230783])],
 ['Au', np.array([ 2.46615392, -1.52416694,  3.99032086])],
 ['Au', np.array([-1.52416694, -3.99032086,  2.46615392])],
 ...
 ['Au', np.array([-1.52416694, -3.99032086, -2.46615392])],
 ['Au', np.array([-2.46615392, -1.52416694, -3.99032086])],
 ['Au', np.array([ 0.        ,  4.57250082,  7.39846175])],
 ['Au', np.array([ 1.52416694,  5.5144878 ,  4.93230783])],
 ['Au', np.array([ 2.46615392,  3.04833388,  6.45647477])],
 ['Au', np.array([ 3.04833388,  6.45647477,  2.46615392])],
 ['Au', np.array([ 3.99032086,  3.99032086,  3.99032086])],
 ['Au', np.array([ 4.93230783,  1.52416694,  5.5144878 ])],
 ['Au', np.array([ 4.57250082,  7.39846175,  0.        ])],
 ['Au', np.array([ 5.5144878 ,  4.93230783,  1.52416694])],
 ['Au', np.array([ 6.45647477,  2.46615392,  3.04833388])],
 ['Au', np.array([ 7.39846175,  0.        ,  4.57250082])],
 ['Au', np.array([-1.52416694,  5.5144878 ,  4.93230783])],
 ['Au', np.array([ 0.        ,  6.45647477,  2.46615392])],
 ['Au', np.array([-3.04833388,  6.45647477,  2.46615392])],
 ['Au', np.array([ 1.52416694,  7.39846175,  0.        ])],
 ['Au', np.array([-1.52416694,  7.39846175,  0.        ])],
 ['Au', np.array([-4.57250082,  7.39846175,  0.        ])],
 ['Au', np.array([-2.46615392,  3.04833388,  6.45647477])],
 ['Au', np.array([-3.99032086,  3.99032086,  3.99032086])],
 ...
 ['Au', np.array([-6.45647477,  2.46615392,  3.04833388])],
 ['Au', np.array([-7.39846175,  0.        ,  4.57250082])],
 ['Au', np.array([ 0.        ,  1.52416694,  7.39846175])],
 ['Au', np.array([-2.46615392,  0.        ,  6.45647477])],
 ['Au', np.array([ 0.        , -1.52416694,  7.39846175])],
 ['Au', np.array([-4.93230783, -1.52416694,  5.5144878 ])],
 ['Au', np.array([-2.46615392, -3.04833388,  6.45647477])],
 ['Au', np.array([ 0.        , -4.57250082,  7.39846175])],
 ...
 ['Au', np.array([ 5.5144878 , -4.93230783,  1.52416694])],
 ['Au', np.array([ 6.45647477, -2.46615392,  3.04833388])],
 ['Au', np.array([ 7.39846175,  0.        ,  1.52416694])],
 ['Au', np.array([ 6.45647477, -2.46615392,  0.        ])],
 ['Au', np.array([ 7.39846175,  0.        , -1.52416694])],
 ['Au', np.array([ 5.5144878 , -4.93230783, -1.52416694])],
 ['Au', np.array([ 6.45647477, -2.46615392, -3.04833388])],
 ['Au', np.array([ 7.39846175,  0.        , -4.57250082])],
...
start_time = time.time()
out_cpp = sfs_cpp.eval_geometry(geo147)
end_time = time.time()
print("Cpp:      {} s".format(end_time-start_time))
...
print("\n--- Ni13Au134 ---")
types = [a[0] for a in geo147]
xyzs = np.array([a[1] for a in geo147])
